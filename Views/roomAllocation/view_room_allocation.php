...
<?php require_once "../Admin/header.php"?>
    <div class="row">
        <div class="col-md-10 col-md-offset-1 col-xs-10 col-xs-offset-1">
            <h1 class="text-center  admin_top_text">View Class Schedule and Room Allocation Information</h1>
            <div class="panel panel-default save_department">
                ...
                <div class="row">
                    <div class="col-sm-6 col-sm-offset-3" style="margin-bottom: 30px">
                        <label for="departmentInRoomAllocation" style="width: 25%; float: left; font-weight: 900; color: #1b3548" class="col-sm-4 form-control">Department</label>
                        <select style="width: 70%; float: right" class="form-control col-sm-8" name="department" id="departmentInRoomAllocation">
...
<!--                    <legend style="text-align: center; color: #1b3548; font-weight: 900">Course Information</legend>-->
                    ...
                    <table class="table table-striped" style="text-align: center">
                        ...
                        <tr>
                            ...
                            <th style="text-align: center">Schedule Info</th>
                        </tr>
                        </thead>
                        <tbody id="viewRoomAllocation" style="color: #1b3548">
